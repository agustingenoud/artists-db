...
import FInputRichSlate from "../Forms/FInputRichSlate";
import ImagenesUploads from "../ImagenesUploads";
import ImgUpload from "../ImgUpload";

import VideosUploads from "../VideosUploads";
import SonidosUploads from "../SonidosUploads";
import PdfsUploads from "../PdfsUploads";
...
function DetalleEvento() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const eventosRef = await firebase.db
        .collection("eventos")
        .doc(id)
        .set(data);
      setEnvio(
  ...
  const handleDelete = async () => {
    try {
      const document = await firebase.db.collection("eventos").doc(id).delete();
